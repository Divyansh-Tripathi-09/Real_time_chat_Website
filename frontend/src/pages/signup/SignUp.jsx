    ...
    <div  className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        ...
        <h1 className='text-3xl font-semibold text-center text-gray-300' >
            ...
            <form on onSubmit={handleSubmit}>
                ...
                <Link to='/login' className='text-sm hover:underline hover:text-blue-600 mt-2 ml-2 inline-block'> Already have an account?</Link>
...
//                 <a href='#' className='text-sm hover:underline hover:text-blue-600 mt-2 ml-2 inline-block'> Already have an account?</a>
